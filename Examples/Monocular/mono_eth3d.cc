...
int main(int argc, char **argv)
{
    if(argc != 6)
    {
        cerr << endl << "Usage: ./mono_eth3d path_to_vocabulary path_to_settings path_to_sequence useDisplay output_path" << endl;
        return 1;
    }
    ...
    bool useDisplay = (string(argv[4]) == "true" || string(argv[4]) == "1");
